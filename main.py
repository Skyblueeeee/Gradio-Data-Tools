...
class GradioDataTools():
    ...
    def _ff_build(self,ff_imagedir_input,ff_dbname_input,ff_json_input10,ff_json_input1,
                ff_json_input2,ff_json_input3,ff_json_input4,ff_json_input5,
                ff_json_input6,ff_json_input7,ff_json_input8,ff_json_input9):

        cf = GRConstuctFlow(ff_dbname_input, back_up=ff_json_input10)
        cf.run( origin_dir= ff_imagedir_input,
    ...
    def gr_ui(self):
        with gr.Blocks(theme=gr.themes.Soft(),title="Gradio-Data-Tools",css=css) as demo:
            ...
            with gr.Tab("数据管理"):
                    ...
                    with gr.Tab("数据库发图"):
                        with gr.Column():
                            with gr.Row():
                                ...
                                ff_json_input13 = gr.Textbox("",label="发图日期",scale=3)
                            with gr.Row():
                ...
                ff_json_input14.click(send_image,inputs=[ff_json_sqlname1,ff_json_input15,ff_json_input12,ff_json_input13],outputs=ff_info_output)
                ff_build_button.click(self._ff_build,inputs=[ff_imagedir_input,ff_dbname_input,ff_json_input10,ff_json_input1,
                                                            ff_json_input2,ff_json_input3,ff_json_input4,ff_json_input5,
                                                            ff_json_input6,ff_json_input7,ff_json_input8,ff_json_input9],outputs=ff_info_output)
                ff_btn_del.click(self._ff_build,inputs=[ff_imagedir_input,ff_json_sqlname,ff_json_input10,ff_json_input1,
                                                            ff_json_input2,ff_json_input3,ff_json_input4,ff_json_input5,
                                                            ff_json_input6,ff_json_input7,ff_json_input8,ff_json_input9],outputs=ff_info_output)
                ff_btn_db.click(self._ff_build,inputs=[ff_imagedir_input,ff_json_sqlname,ff_json_input10,ff_json_input1,
                                                            ff_json_input2,ff_json_input3,ff_json_input4,ff_json_input5,
                                                            ff_json_input6,ff_json_input7,ff_json_input8,ff_json_input9],outputs=ff_info_output)
            ...
            with gr.Tab("数据分析"):
                ...
                with gr.Tab("COCO标签"): 
                    with gr.Column():
                        with gr.Row():
                            cal_input1 = gr.Textbox(self.label_path,label="数据地址",scale=5)
                ...
                cal_ok_btm.click(print_statistics,inputs=cal_input1,outputs=[cal_info_df,imgs_num,gr_scatter_plot,gr_line_plot,gr_bar_plot])
            ...
            with gr.Tab("提取标签"):
                ...
                with gr.Column():
                    ...
                    with gr.Row():
                        ...
                        super_btn = gr.Button("确认",icon=self.refresh_icon_path,elem_classes='refreshbutton')
            ...
            with gr.Tab("JSON互转"):
                        ...
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                with gr.Row():
                                    ...
                                    super_text = gr.Textbox(label="添加模板")
                                    super_btn = gr.Button("确认",icon=self.refresh_icon_path)
                            
                        json_info_output = gr.Textbox(label = "输出信息",lines=15,max_lines=15)
                        json_ok_button = gr.Button("确认",variant="primary")
                ...
                json_ok_button.click(run_viatococo,inputs=[json_dir_input,json_vianame_input1,json_coconame_input1,json_supercategory_input1],outputs=json_info_output)
                ...
                with gr.Tab("coco2via"):
                    with gr.Column():
                        ...
                        json_info_output = gr.Textbox(label = "输出信息",lines=15,max_lines=15)
                        json_ok_button = gr.Button("确认",variant="primary")
                json_ok_button.click(main_coco2via,inputs=[json_dir_input,json_coconame_input2,json_vianame_input2,json_supercategory_input2],outputs=json_info_output)
                ...
                with gr.Tab("coco2yolo"):
                    with gr.Column():
                        ...
                        json_info_output = gr.Textbox(label = "输出信息",lines=15,max_lines=15)
                        json_ok_button = gr.Button("确认",variant="primary")
                json_ok_button.click(coco_to_txt,inputs=[json_dir_input,json_coconame_input2],outputs=json_info_output)
